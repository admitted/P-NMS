...
qikoo.dialog = function() {
    var e, t, n = {}, r = function() {
            ...
            t.css("width", "480px"), t.find(".dialog-title").html(n.title), t.find(".dialog-main").html(n.html), t.show(), e.show(), s()
        }, s = function() {
    ...
    var r = ['<div class="dialog-content">', "<p>" + e + "</p>", "</div>",'<a class="console-btn-confirm" href="#" onclick="return false;">确定</a>', '<a class="console-btn-cancel" href="#" onclick="return false;">取消</a>', "</div>"].join(""),
        i = qikoo.dialog.show({
            html: r
        });
